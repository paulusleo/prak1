...
class Student {
    ...
    int checkStudent(){
        ...
        System.out.print("Masukkan NIM Anda (input 78 untuk kembali): ");
    ...
    void pinjamBuku(int j){
        Main main = new Main();
        Scanner scanString = new Scanner (System.in);
        System.out.println("Input id buku yang ingin anda pinjam (input 78 untuk kembali)");
...
class Admin {
    ...
    public static String passx = "leo123";
...
public class Main {
    //data buku
    public static String[] idBuku = new String[] {"498d-e672-8132", "lo85-be20-3cbk", "d85e-1c3a-1978"};
