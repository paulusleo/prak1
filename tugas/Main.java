...
public class Main {
    ...
    public static void main(String[] args) {
        // Mengisi stok buku
        daftarBuku.add(0, new Book("le19-ol78-12po", " Pitulungan ", 3, "Novel" , " Paulus "));
        daftarBuku.add(1, new Book("03ci-nt22-a4l2", " Who i am", 9, "Novel", " Leo "));
        daftarBuku.add(2, new Book("171a-ad19-p2nb", " Avatar ", 10, "Novel", " Martin "));
    ...
    public static class Admin extends User {
        ...
        private boolean isAdmin(String username, String password) {
            ...
            return username.equals("admin") && password.equals("leole");
        }
